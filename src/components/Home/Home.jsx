...
export const Home = () => {
  ...
  return (
    <section className='min-h-[calc(100vh-5rem)] w-[100%] flex justify-center lg:w-[100%] lg:flex lg:justify-center relative' id='home'>
      <div className=" container w-[100%] lg:w-[90%] min-h-[80vh] lg:max-h-[40vh] flex flex-col-reverse lg:flex-row  justify-center items-center">
        ...
        <div className="w-[70%] lg:w-[100%] flex justify-center ">
